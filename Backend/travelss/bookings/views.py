...
# authication process, permissions, response . and by username and password tokane is shown and response also shown , genreics and api viewss which are rest framework we implement these
