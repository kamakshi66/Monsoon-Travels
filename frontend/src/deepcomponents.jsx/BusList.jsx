        ...
        >
          <div className="p-4">
            <div className="flex justify-between items-center mb-2">
              <div>
                <h2 className="text-lg font-semibold text-purple-800">{bus.bus_name}</h2>
                <p className="text-gray-600 text-sm">Bus No: {bus.number}</p>
              </div>
              <span className="bg-green-200 text-green-700 text-xs font-medium px-2 py-0.5 rounded">
                Available
              </span>
            </div>
            ...
            <div className="text-gray-600 text-sm space-y-1">
              ...
              <p>Depart: {bus.start_time}</p>
              <p>Arrive: {bus.reach_time}</p>
            </div>

            <button
              onClick={() => handleViewSeats(bus.id)}
              className="mt-4 w-full bg-purple-200 hover:bg-black-300 text-gray-800 font-medium py-2 rounded transition-colors duration-200"
            >
              View Seats & Book
            </button>
          </div>
